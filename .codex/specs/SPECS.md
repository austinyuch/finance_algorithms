...
| [_e-mlops-tier3_](./e-mlops-tier3-readiness.md) | E | **Planning-ready · Implementation deferred**(E-lite registry recommended; no serving/retraining/drift yet) | d(3 model families),f-showcase-read-api-dashboard | future experiment registry / config catalog | — | (TBD) |
| [f-showcase-read-api-dashboard](./f-showcase-read-api-dashboard/) + [f-nextjs-showcase-dashboard](./f-nextjs-showcase-dashboard/) | F | **Implemented(local Next.js runtime)· Review PASSED**(local HTTP smoke; public hosting deferred) | a0(read API),c-portfolio-core,d-first-regime-model,d-return-risk-forecast-model,d-robust-portfolio-optimization-model | QuantLab result-store/read surface; no legacy API behavior change | — | `spec/f-showcase-and-d-return-risk` |
