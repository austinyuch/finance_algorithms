...
| `test_b_1_vintage` | FRED/Stooq vintage loader to PIT provider, empty dir | b-data-platform B-1 | 3 pass |
...
| `test_daily_snapshot` | bitemporal stamping, append-only write, parser wrappers, graceful degradation | data vintage routine | 9 pass |
