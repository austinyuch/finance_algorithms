...
```bash
uv run python scripts/capture_pytest_gate.py  # 424 passed → docs/review/assets/gate-pytest.txt
...
uv run lint-imports                  # KEPT, 87 files / 237 deps → gate-lint-imports.txt
