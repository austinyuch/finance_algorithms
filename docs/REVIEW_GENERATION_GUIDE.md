...
```bash
uv run python scripts/capture_pytest_gate.py  # 324 passed → docs/review/assets/gate-pytest.txt
...
uv run lint-imports                  # KEPT, 76 files / 197 deps → gate-lint-imports.txt
