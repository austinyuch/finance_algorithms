...
| [d-first-regime-model](./d-first-regime-model/) + [d-return-risk-forecast-model](./d-return-risk-forecast-model/) | D | **Implemented(regime first slice + return/risk second slice)· Review PASSED**(OOS-net baselines; no alpha claim; no Tier3) | a0-backtest-foundation,b-data-platform,c-portfolio-core | c-portfolio-core(C-3 regime hook consumed additively); A0 regime scheduling; F showcase payloads | — | `spec/d-first-regime-model`; `spec/f-showcase-and-d-return-risk` |
| _e-mlops-tier3_ | E | Deferred(R3) | d | — | — | (TBD) |
| [f-showcase-read-api-dashboard](./f-showcase-read-api-dashboard/) | F | **Implemented(repo-side read API/dashboard payload)· Review PASSED**(hybrid smoke; Next.js runtime deferred) | a0(read API),c-portfolio-core,d-first-regime-model,d-return-risk-forecast-model | QuantLab result-store read surface; no legacy API behavior change | — | `spec/f-showcase-and-d-return-risk` |
