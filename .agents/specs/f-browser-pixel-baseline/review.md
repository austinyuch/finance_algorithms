...
- Proven in this lane: real chromium-headless screenshot plus pixel diff evidence. Latest refreshed evidence records `1049 / 1,296,000` mismatched pixels at threshold `0.001`, screenshot hash `9c2e5fe8651694969deafe256918c113c9f189823102da3554840bfe644bc4f3`.
...
- Browser visual smoke: **passed**, repo-baseline pixel diff `1049 / 1,296,000`.
