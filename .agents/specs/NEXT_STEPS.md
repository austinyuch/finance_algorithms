...
- **F browser pixel baseline lane:** [f-browser-pixel-baseline](./f-browser-pixel-baseline/) is **Implemented · Review PASSED**.
  ...
  - Latest browser visual diff: `230 / 1,296,000` mismatched pixels, `mismatchRatio=0.00017746913580246913`, threshold `0.001`.
