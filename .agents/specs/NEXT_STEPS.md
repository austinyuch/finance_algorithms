...
- **Current branch lane:** `spec/e-tier3-retraining-evidence`. This lane adds repo-side local retraining smoke evidence while preserving the Tier3 gate's fail-closed boundary.
