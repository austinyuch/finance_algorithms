...
- **Current branch lane:** none after `e-tier3-readiness-proof-cli` promotion. Next implementation work should branch from `origin/main`; the E CLI lane is merged to both `dev` and `main`.
