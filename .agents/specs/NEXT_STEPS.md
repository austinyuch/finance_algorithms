...
- **Current branch lane:** post-E-serving governance sync. The E Tier3 serving smoke evidence slice is already promoted to both long-lived branches; keep the next action focused on remaining external/runtime residuals.
