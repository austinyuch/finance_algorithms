...
- **F browser pixel baseline lane:** [f-browser-pixel-baseline](./f-browser-pixel-baseline/) is **Implemented · Review PASSED**.
  ...
  - Latest browser visual diff: `235 / 1,296,000` mismatched pixels, `mismatchRatio=0.00018132716049382717`, threshold `0.001`.
