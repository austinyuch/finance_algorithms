...
- **F browser pixel baseline lane:** [f-browser-pixel-baseline](./f-browser-pixel-baseline/) is **Implemented · Review PASSED**.
  ...
  - Latest browser visual diff: `1024 / 1,296,000` mismatched pixels, `mismatchRatio=0.0007901234567901234`, threshold `0.001`.
