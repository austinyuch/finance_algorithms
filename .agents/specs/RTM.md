...
| Gate | Command | Result |
|---|---|---|
| Python suite | `uv run pytest -q` | **255 passed** |
...
| E registry line coverage | `uv run pytest --cov=quantlab.mlops.experiment_registry --cov-report=term-missing tests/quantlab/test_e_1_experiment_registry.py` | 29 passed; 100% line coverage |
