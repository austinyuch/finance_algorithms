...
| Gate | Command | Result |
|---|---|---|
| Python suite | `uv run pytest -q` | **188 passed, 1 skipped** |
...
| Python mutation | `uv run python scripts/run_mutation_spot_checks.py` | 23/23 killed, including `root-torch-default-dependency` |
