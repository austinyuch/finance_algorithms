...
| Gate | Command | Result |
|---|---|---|
| Python suite | `uv run pytest -q` | **237 passed** |
...
| Browser visual | `cd frontend && npm run visual:browser` | `proven`; repo-baseline pixel diff `1024 / 1,296,000` at threshold `0.001` |
