...
| Gate | Command | Result |
|---|---|---|
| Python suite | `uv run pytest -q` | **194 passed, 1 skipped** |
...
| Python mutation | `uv run python scripts/run_mutation_spot_checks.py --only governance-stale-post-merge-sync-promotion`; full suite configured in `scripts/run_mutation_spot_checks.py` | targeted stale post-merge sync promotion mutation killed; current suite contains 26/26 configured mutations |
