...
4. **Mutation 自動化**:mutmut 3.x sandbox 與本 layout 不相容;repo-local `scripts/run_mutation_spot_checks.py` 已成為跨 spec governance runner,目前 69/69 configured mutations killed。完整 mutmut score 仍非本 slice 目標。
