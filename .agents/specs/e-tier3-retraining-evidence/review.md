...
Keep the Tier3 gate fail-closed. The next valuable E slice is automated drift-monitoring evidence; B scheduled cron proof remains separately pending until GitHub emits a successful `event=schedule` run.
